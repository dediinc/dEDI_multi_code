  ...
  return (
    <>
      <div className="container">
        ...
        <div id="org_container" className="container1">
          <div id="org_body" className="body">
            <div id="org_footer" className="footer">
              <span id="org_footer_copy" className="copyright">
            ...
            <div id="org_header" className="header">
              <img
                id="org_header_logo"
                alt="dEDI logo"
                src="/playground_assets/dedi_logo_trans-1000h.png"
            ...
            <div id="org_main" className="main">
              <div id="org_form_container" className="userformcontainer">
                <div id="org_form" className="userform">
                  <input
                    type="email"
                    id="org_email_input"
                    name="Email"
                ...
                <h1 id="org_form_header" className="text">
