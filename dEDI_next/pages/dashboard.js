  ...
  return (
    <>
      <div className="container">
        ...
        <div id="c_dash_container" className="container1">
          <div id="c_dash_body_a" className="body">
            <div id="c_dash_footer" className="footer">
              <img
              ...
              />
              <span id="c_dash_footer_copy" className="copyright">
                © 2021 dEDI Incorporated
              </span>
            </div>
            <div id="c_dash_header" className="header">
              <img
            ...
            <div id="c_dash_sidebar" className="sidebar">
              <div id="c_dash_menu" className="menu">
                <Link href="/dashboard">
                  <a className="link">
                    <div
                    ...
                    >
                      ...
                      <span id="c_dash_menu_title_1" className="dashdashtitle">
                        dashboard
                      </span>
                    </div>
                  </a>
                </Link>
                <div id="c_dash_menu-link_2" className="dashworkinglink">
                  <svg
                  ...
                  <span id="c_dash_menu_title_1" className="dashworkingtitle">
                    working
                  </span>
                </div>
                <Link href="/forms">
                  <a className="link1">
                    ...
                    >
                      ...
                      <span id="c_dash_menu_title_3" className="dashformstitle">
                        <span>forms</span>
                      </span>
                    </div>
                  </a>
                ...
                <Link href="/messages">
                  <a className="link2">
                    ...
                    >
                      ...
                      <span id="c_dash_menu_title_4" className="dashmsgstitle">
                        <span>msgs</span>
                      </span>
                    </div>
                  </a>
                </Link>
                <div id="c_dash_menu-link_5" className="dashpartnerslink">
                  <svg
                  ...
                  <span id="c_dash_menu_title_5" className="dashpartnerstitle">
                    <span>partners</span>
                  </span>
                </div>
                <div id="c_dash_menu-link_6" className="dashtrackinglink">
                  <svg
                  ...
                  <span id="c_dash_menu_title_6" className="dashtrackingtitle">
                    <span>tracking</span>
                  </span>
                </div>
                <div id="c_dash_menu-link_7" className="dashinventorylink">
                  <svg
                  ...
                  <span id="c_dash_menu_title_7" className="dashinventorytitle">
                    <span>inventory</span>
                  </span>
                </div>
                <div id="c_dash_menu-link_8" className="dashfinanciallink">
                  <svg
                  ...
                  <span id="c_dash_menu_title_8" className="dashfinancialtitle">
                    <span>financial</span>
                  </span>
                </div>
              </div>
            ...
            <div id="c_dash_main" className="main">
              <div id="c_dash_main_left_column" className="leftcolumn">
                <div id="c_dash_left_column_dash_a" className="dasha"></div>
                <div id="c_dash_left_column_dash_b" className="dashb"></div>
                <div id="c_dash_left_column_dash_c" className="dashc"></div>
                <div id="c_dash_left_column_dash_d" className="dashd"></div>
              </div>
              <div id="c_dash_main_right_column" className="rightcolumn">
                <div id="c_dash_right_columb_dash_e" className="dashe"></div>
                <div id="c_dash_right_columb_dash_f" className="dashf"></div>
                <div id="c_dash_right_columb_dash_g" className="dashg"></div>
                <div id="c_dash_right_columb_dash_h" className="dashh"></div>
              </div>
              <h1 className="text6">
                <span>dashboard</span>
              </h1>
