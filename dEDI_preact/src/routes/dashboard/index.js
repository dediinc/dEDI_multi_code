...
const Dashboard = () => {
  return (
    <div class={styles['container']}>
      ...
      <div id="c_dash_container" class={styles['container1']}>
        <div id="c_dash_body_a" class={styles['body']}>
          <div id="c_dash_footer" class={styles['footer']}>
            <img
            ...
            />
            <span id="c_dash_footer_copy" class={styles['copyright']}>
              © 2021 dEDI Incorporated
            </span>
          </div>
          <div id="c_dash_header" class={styles['header']}>
            <img
          ...
          <div id="c_dash_sidebar" class={styles['sidebar']}>
            <div id="c_dash_menu" class={styles['menu']}>
              <Link href="/dashboard" class={styles['navlink']}>
                ...
                >
                  ...
                  <span
                    ...
                    class={styles['dashdashtitle']}
                  >
                    dashboard
                  </span>
                </div>
              </Link>
              <div id="c_dash_menu-link_2" class={styles['dashworkinglink']}>
                <svg
              ...
              <Link href="/messages" class={styles['navlink2']}>
                ...
                >
                  ...
                  <span
                    ...
                    class={styles['dashmsgstitle']}
                  >
                    <span>msgs</span>
                  </span>
                </div>
              </Link>
              <div id="c_dash_menu-link_5" class={styles['dashpartnerslink']}>
                <svg
              ...
              <div id="c_dash_menu-link_6" class={styles['dashtrackinglink']}>
                <svg
              ...
              <div id="c_dash_menu-link_7" class={styles['dashinventorylink']}>
                <svg
              ...
              <div id="c_dash_menu-link_8" class={styles['dashfinanciallink']}>
                <svg
          ...
          <div id="c_dash_main" class={styles['main']}>
            <div id="c_dash_main_left_column" class={styles['leftcolumn']}>
              <div id="c_dash_left_column_dash_a" class={styles['dasha']}></div>
              <div id="c_dash_left_column_dash_b" class={styles['dashb']}></div>
              <div id="c_dash_left_column_dash_c" class={styles['dashc']}></div>
              <div id="c_dash_left_column_dash_d" class={styles['dashd']}></div>
            </div>
            <div id="c_dash_main_right_column" class={styles['rightcolumn']}>
              <div
