<template>
  <div class="component7-container">
    <svg viewBox="0 0 1024 1024" class="component7-icon">
      <path
      ...
      ></path></svg
    ><svg viewBox="0 0 1024 1024" class="component7-icon02">
      <path
    ...
    ><svg viewBox="0 0 1024 1024" class="component7-icon08">
      ...
      ></path></svg
    ><svg viewBox="0 0 1097.142857142857 1024" class="component7-icon10">
      <path
    ...
    <div class="component7-container1">
      <div class="component7-container2">
        <svg viewBox="0 0 1024 1024" class="component7-icon12">
          <path
        ...
        <a
          ...
          class="component7-dashboard thqLink"
        >
          <span>dashboard</span>
        </a>
      </div>
...
import AppComponent4 from './component4'
