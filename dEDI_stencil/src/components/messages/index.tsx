...
export class Messages {
  render() {
    return (
      <div class="container">
        <stencil-route-title pageTitle="messages - dEDI Icn" />
        <div id="msg_container" class="container1">
          <div id="msg_body" class="body">
            <div id="msg_footer" class="footer">
              <img
                id="msg_footer_logo"
                alt="image"
                ...
                class="footerlogo"
              />
              <span id="msg_footer_copy" class="copyright">
                © 2021 dEDI Incorporated
              </span>
            </div>
            <div id="msg_header" class="header">
              <img
                id="msg_header_logo"
                alt="dEDI logo"
            ...
            <div id="msg_sidebar" class="sidebar">
              <div id="msg_menu" class="menu">
                <div id="msg_menu-link_1" class="dashdashlink">
                  <svg
                    id="msg_menu_icon_1"
                  ...
                  <span id="msg_menu_title_1" class="dashdashtitle">
                    dashboard
                  </span>
                </div>
                <div id="msg_menu-link_2" class="dashworkinglink">
                  <svg
                    id="msg_menu_icon_2"
                    viewBox="0 0 1024 1024"
                  ...
                  <span id="msg_menu_title_1" class="dashworkingtitle">
                    working
                  </span>
                </div>
                <div id="msg_menu-link_3" class="dashformslink">
                  <svg
                    id="msg_menu_icon_3"
                  ...
                  <span id="msg_menu_title_3" class="dashformstitle">
                    <span class="">forms</span>
                  </span>
                </div>
                <div id="msg_menu-link_4" class="dashmsgslink">
                  <svg
                    id="msg_menu_icon_4"
                    viewBox="0 0 1024 1024"
                    class="dashmsgsicon"
                  ...
                  <span id="forms_menu_title_4" class="dashmsgstitle">
                    <span class="">msgs</span>
                  </span>
                </div>
                <div id="forms_menu-link_5" class="dashpartnerslink">
                  <svg
                  ...
                  <span id="forms_menu_title_5" class="dashpartnerstitle">
                    <span class="">partners</span>
                  </span>
                </div>
                <div id="forms_menu-link_6" class="dashtrackinglink">
                  <svg
                  ...
                  <span id="forms_menu_title_6" class="dashtrackingtitle">
                    <span class="">tracking</span>
                  </span>
                </div>
                <div id="forms_menu-link_7" class="dashinventorylink">
                  <svg
                  ...
                  <span id="forms_menu_title_7" class="dashinventorytitle">
                    <span class="">inventory</span>
                  </span>
                </div>
                <div id="forms_menu-link_8" class="dashfinanciallink">
                  <svg
                  ...
                  <span id="forms_menu_title_8" class="dashfinancialtitle">
            ...
            <div id="forms_content" class="main">
              <div id="forms_content_container" class="contentcolumn">
                <div id="msg_msg_preview" class="msgpreview">
                  <div id="contact_preview_1" class="contactpreview">
                    <svg
                    ...
                    <span id="contact_msg_name_1" class="msgcompanyname">
                      <span class="text06">Company c</span>
                    </span>
                    <span id="contact_msg_1" class="text07">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_1" class="text08">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_2" class="contactpreview01">
                    <svg
                    ...
                    <span id="contact_msg_name_2" class="msgcompanyname01">
                      <span class="text09">Company c</span>
                    </span>
                    <span id="contact_msg_2" class="text10">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_2" class="text11">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_3" class="contactpreview02">
                    <svg
                    ...
                    <span id="contact_msg_name_3" class="msgcompanyname02">
                      <span class="text12">Company c</span>
                    </span>
                    <span id="contact_msg_3" class="text13">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_3" class="text14">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_4" class="contactpreview03">
                    <svg
                    ...
                    <span id="contact_msg_name_4" class="msgcompanyname03">
                      <span class="text15">Company c</span>
                    </span>
                    <span id="contact_msg_4" class="text16">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_4" class="text17">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_5" class="contactpreview04">
                    <svg
                    ...
                    <span id="contact_msg_name_5" class="msgcompanyname04">
                      <span class="text18">Company c</span>
                    </span>
                    <span id="contact_msg_5" class="text19">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_5" class="text20">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_6" class="contactpreview05">
                    <svg
                    ...
                    <span id="contact_msg_name_6" class="msgcompanyname05">
                      <span class="text21">Company c</span>
                    </span>
                    <span id="contact_msg_6" class="text22">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_6" class="text23">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_7" class="contactpreview06">
                    <svg
                    ...
                    <span id="contact_msg_name_7" class="msgcompanyname06">
                      <span class="text24">Company c</span>
                    </span>
                    <span id="contact_msg_7" class="text25">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_7" class="text26">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_8" class="contactpreview07">
                    <svg
                    ...
                    <span id="contact_msg_name_8" class="msgcompanyname07">
                      <span class="text27">Company c</span>
                    </span>
                    <span id="contact_msg_8" class="text28">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_8" class="text29">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_9" class="contactpreview08">
                    <svg
                    ...
                    <span id="contact_msg_name_9" class="msgcompanyname08">
                      <span class="text30">Company c</span>
                    </span>
                    <span id="contact_msg_9" class="text31">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_9" class="text32">
                      today 1354
                    </span>
                  </div>
                  <div id="contact_preview_10" class="contactpreview09">
                    <svg
                    ...
                    <span id="contact_msg_name_10" class="msgcompanyname09">
                      <span class="text33">Company c</span>
                    </span>
                    <span id="contact_msg_10" class="text34">
                      ipsum lorem ipsum lorem ipsum lorem ipsum loremipsum lorem
                      ipsum lorem ipsum lorem ipsum loremipsum lorem ipsum lor
                    </span>
                    <span id="contact_msg_rcvd_10" class="text35">
                      today 1354
                    </span>
                  </div>
                </div>
                <div id="active_msg_form" class="activemsgform">
                  <div id="active_msg_container_2" class="container2">
                    <svg
                    ...
                    <span id="active_msg_msg_2" class="text36">
                      <span class="">
                    ...
                    <span id="active_msg_msg_3" class="text38">
                      <span class="">
                        This would be a message from the user in response to his
                        trading partner.
                        <span innerHTML=" " />
                    ...
                    <span id="active_msg_time_2" class="text40">
                      <span class="">Today 1501</span>
                    </span>
                    <span id="active_msg_time_3" class="text42">
                      <span class="">Today 1503</span>
                    </span>
                  </div>
                  <div id="active_msg_container_3" class="container3">
                    <svg
                    ...
                    <span id="active_msg_msg_4" class="text44">
                      This would be a message the last message received in this
                      message.
                      <span innerHTML=" " />
                    </span>
                    <span id="active_msg_time_4" class="text45">
                      <span class="">Today 1530</span>
                    </span>
                  </div>
                  <div id="active_msg_container_1" class="container4">
                    <svg
                    ...
                    <span id="active_msg_msg_1" class="text47">
                      This would be a message from the partner if this were a
                      real message it would say something REALLY important.
                      <span innerHTML=" " />
                    </span>
                    <span id="active_msg_time_1" class="text48">
                      <span class="">Today 1436</span>
                    </span>
                  </div>
                  <div id="active_msg_entry_container" class="container5">
                    <div id="active_msg_entry_text" class="container6">
                      <textarea
                        id="msg_msg_input"
                        name="msg_input"
                        placeholder="message here"
                        class="textarea thqTextArea"
                      ></textarea>
                    </div>
                    <button
                      id="active_msg_send_button"
                      name="send_button"
                      class="button thqButton"
                    >
                      send
                    </button>
                  </div>
              ...
              <h1 id="forms_content_header" class="text50">
