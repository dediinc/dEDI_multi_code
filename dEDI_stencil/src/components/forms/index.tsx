...
export class Forms {
  render() {
    return (
      <div class="container">
        <stencil-route-title pageTitle="forms - dEDI Icn" />
        <div id="forms_container" class="container1">
          <div id="forms_body" class="body">
            <div id="forms_footer" class="footer">
              <img
                ...
                class="footerlogo"
              />
              <span id="forms_footer_copy" class="copyright">
                © 2021 dEDI Incorporated
              </span>
            </div>
            <div id="forms_header" class="header">
              <img
            ...
            <div id="forms_sidebar" class="sidebar">
              <div id="forms_menu" class="menu">
                <stencil-route-link url="/dashboard" class="navlink">
                  <div id="forms_menu-link_1" class="dashdashlink thqLink">
                    <svg
                    ...
                    <span id="forms_menu_title_1" class="dashdashtitle">
                      dashboard
                    </span>
                  </div>
                </stencil-route-link>
                <div id="forms_menu-link_2" class="dashworkinglink">
                  <svg
                  ...
                  <span id="forms_menu_title_1" class="dashworkingtitle">
                    working
                  </span>
                </div>
                <stencil-route-link url="/forms" class="navlink1">
                  <div id="forms_menu-link_3" class="dashformslink thqLink">
                    <svg
                    ...
                    <span id="forms_menu_title_3" class="dashformstitle">
                      <span class="">forms</span>
                    </span>
                  </div>
                </stencil-route-link>
                <stencil-route-link url="/messages" class="navlink2">
                  <div id="forms_menu-link_4" class="dashmsgslink thqLink">
                    <svg
            ...
            <div id="forms_content" class="main">
              <div id="forms_content_container" class="contentcolumn"></div>
              <h1 id="forms_content_header" class="text6">
                <span class="">forms</span>
              </h1>
            </div>
          </div>
