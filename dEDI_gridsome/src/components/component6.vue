<template>
  <div class="component6-container">
    <svg viewBox="0 0 1024 1024" class="component6-icon">
      <path
      ...
      ></path></svg
    ><svg viewBox="0 0 1024 1024" class="component6-icon02">
      <path
      ...
      ></path></svg
    ><svg viewBox="0 0 950.8571428571428 1024" class="component6-icon04">
      <path
      ...
      ></path></svg
    ><svg viewBox="0 0 1024 1024" class="component6-icon06">
      <path
      ...
      ></path></svg
    ><svg viewBox="0 0 1024 1024" class="component6-icon08">
      <path
      ...
      ></path></svg
    ><svg viewBox="0 0 1097.142857142857 1024" class="component6-icon10">
      <path
    ...
    <div class="component6-container1">
      <app-component1 rootClassName="rootClassName"></app-component1>
...
<script>
import AppComponent1 from './component1'
