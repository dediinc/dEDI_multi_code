...
const Forms = () => {
  return (
    <div className={styles['container']}>
      ...
      <div id="forms_container" className={styles['container1']}>
        <div id="forms_body" className={styles['body']}>
          <div id="forms_footer" className={styles['footer']}>
            <img
            ...
            />
            <span id="forms_footer_copy" className={styles['copyright']}>
              © 2021 dEDI Incorporated
            </span>
          </div>
          <div id="forms_header" className={styles['header']}>
            <img
          ...
          <div id="forms_sidebar" className={styles['sidebar']}>
            <div id="forms_menu" className={styles['menu']}>
              ...
              <div id="forms_menu-link_2" className={styles['dashworkinglink']}>
                <svg
          ...
          <div id="forms_content" className={styles['main']}>
            ...
            ></div>
            <h1 id="forms_content_header" className={styles['text6']}>
              <span>forms</span>
            </h1>
          </div>
        </div>
