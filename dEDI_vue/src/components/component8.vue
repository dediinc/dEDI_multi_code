<template>
  <div class="component8-container">
    <svg viewBox="0 0 1024 1024" class="component8-icon">
      <path
    ...
    <a
      ...
      class="component8-dashboard thqLink"
    >
      <span>dashboard</span>
    </a>
  </div>
